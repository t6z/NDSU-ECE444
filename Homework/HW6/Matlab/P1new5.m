...
% ******************************************************
% ******* Pairing to create second order systems *******
% ******************************************************

% create 2nd order real systems to cascade
I = length(Zdig);
for i = 1:I/2
    Zdig2(i,:) = poly([Zdig_sort(i,1),Zdig_sort(I+1-i,1)]);
end

% create 2nd order real systems to cascade
I = length(Pdig);
for i = 1:I/2
    Pdig2(i,:) = poly([Pdig_sort(i,1),Pdig_sort(I+1-i,1)]);
end
