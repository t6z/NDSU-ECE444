...
% This version "WithTestCCode" has, at the bottom, a general structure for
% how I planned to implement on K22F target.
...
for k = 1:length(F) % lower pass band frequencies (Hz)
    ...
    wp1_w_store = [wp1_w_store;wp1_w];
    wp2_w_store = [wp2_w_store;wp2_w];
